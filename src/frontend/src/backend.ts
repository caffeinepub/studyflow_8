...
export class Backend implements backendInterface {
    ...
    async addSubject(arg0: string): Promise<Subject> {
        if (this.processError) {
            try {
    ...
    async addTodo(arg0: string): Promise<{
        id: bigint;
        createdAt: bigint;
        text: string;
        completed: boolean;
    ...
    async addTopics(arg0: string, arg1: Array<string>): Promise<Array<Topic>> {
        if (this.processError) {
            try {
                const result = await this.actor.addTopics(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteSubject(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async deleteTopic(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async ensureUser(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.ensureUser();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDailySessions(): Promise<Array<StudySession>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailySessions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveDailySession(arg0: string, arg1: bigint, arg2: bigint, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveDailySession(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleTodo(arg0: bigint): Promise<TodoItem> {
        if (this.processError) {
            try {
    ...
    async toggleTopic(arg0: string): Promise<Topic> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleTopic(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
